  ...
  const work = [
    {
      ...
      note: "Embed: AF Save Squad Annie Greg Ep2V1HB.mp4",
    },
    {
      ...
      note: "Embed: The Impersonation InvasionHB(1).mp4",
    },
    {
      ...
      note: "Embed: Thriller Webinar VideoHB.mp4",
    },
  ];
    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-neutral-950/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          <div>
            <p className="text-lg font-semibold tracking-tight">StoryLabDigital</p>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-28">
            <div className="relative z-10 flex flex-col justify-center">
              ...
              <h1 className="max-w-2xl text-5xl font-semibold tracking-tight text-white sm:text-6xl lg:text-7xl">
                We turn complex business ideas into video people actually understand and remember.
              </h1>
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-6">
                      ...
                      <div className="mt-5 grid grid-cols-3 gap-3">
                        {['Save Squad', 'Impersonation', 'Thriller'].map((item) => (
                          <div key={item} className="rounded-2xl border border-white/10 bg-black/40 p-3 text-xs text-white/70 backdrop-blur-sm">
                            {item}
                          </div>
                        ))}
                      </div>
        ...
        <section className="border-y border-white/10 bg-black/30">
          <div className="mx-auto grid max-w-7xl gap-8 px-6 py-10 text-sm text-white/55 lg:grid-cols-3 lg:px-8">
            <p>
              Long documents get ignored.
            </p>
            <p>
              Presentations get forgotten.
            </p>
            <p>
              Strong visual storytelling cuts through the noise.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-blue-300/80">About StoryLabDigital</p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-4 lg:px-8">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {highlights.map((item) => (
              <div key={item} className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5 text-sm text-white/75">
                {item}
              </div>
            ))}
          </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/8 to-white/4 p-8 lg:p-10">
            <div className="grid gap-8 lg:grid-cols-2">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-blue-300/80">Why StoryLabDigital</p>
                <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
        ...
        <section id="process" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {process.map((item) => (
              <div key={item.step} className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
        ...
        <section id="contact" className="mx-auto max-w-7xl px-6 pb-24 pt-8 lg:px-8">
          <div className="rounded-[2rem] border border-blue-400/20 bg-gradient-to-br from-blue-500/15 via-white/5 to-white/5 p-8 lg:p-12">
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-blue-200/80">Ready to start?</p>
